...
using System.Linq;
using System.Text;
using Sansunt.Infra.Logs.Contents;
using Sansunt.Infra.Logs.Properties;
using Sansunt.Infra.Tools;
using Sansunt.Infra.Tools.Exceptions;
using Sansunt.Infra.Tools.Helpers;
using Sansunt.Infra.Tools.Logs;
using Sansunt.Infra.Tools.Logs.Extensions;

namespace Sansunt.Infra.Logs.Extensions {
    /// <summary>
    /// 日志扩展
    /// </summary>
    public static partial class Extensions {
        ...
        private static string GetParamLiterals( object value ) {
            ...
            switch( value.GetType().Name.ToLower() ) {
                case "boolean":
                    return Tools.Helpers.Convert.ToBool( value ) ? "1" : "0";
                case "int16":
                case "int32":
                case "int64":
                case "single":
