...
using Sansunt.Infra.Tools.Security.Principals;

namespace Sansunt.Infra.Tools.Helpers
{
    /// <summary>
    /// Web操作
    /// </summary>
    public static class Web
    {
        ...
        /// Web客户端，用于发送Http请求
        /// </summary>
        public static Sansunt.Infra.Tools.Webs.Clients.WebClient Client()
        {
            return new Sansunt.Infra.Tools.Webs.Clients.WebClient();
        }
        ...
        public static Sansunt.Infra.Tools.Webs.Clients.WebClient<TResult> Client<TResult>() where TResult : class
        {
            return new Sansunt.Infra.Tools.Webs.Clients.WebClient<TResult>();
        }
