namespace Sansunt.Infra.Tools.Files {
    /// <summary>
    /// 文件大小
    /// </summary>
    public struct FileSize {
        ...
        public double GetSizeByK() {
            return Sansunt.Infra.Tools.Helpers.Convert.ToDouble( _size / 1024.0, 2 );
        }
        ...
        public double GetSizeByM() {
            return Sansunt.Infra.Tools.Helpers.Convert.ToDouble( _size / 1024.0 / 1024.0, 2 );
        }
        ...
        public double GetSizeByG() {
            return Sansunt.Infra.Tools.Helpers.Convert.ToDouble( _size / 1024.0 / 1024.0 / 1024.0, 2 );
        }
