...
namespace Sansunt.Infra.Caches
{
    ...
    public class CacheKey
    {
        ...
        private const string Province = Systemstring + "Province";
        private const string City = Systemstring + "City";
        private const string Area = Systemstring + "Area";
        private const string DicConfig = Systemstring + "DicConfig";
        #endregion
        #region 属性
        /// <summary>
        /// 获取系统的所有菜单
        ...
        /// </summary>
        /// <returns></returns>
        public static string GetDicConfig()
        {
            return DicConfig;
        }
        #endregion
